...
int main(int argc, char **argv)
{
    ...
    if (strcmp(model, "Luckfox Pico Plus") == 0) {
        printf("The device model is Luckfox Pico Plus.\n");
        disp_flag = 1;
    } 
    else if (strcmp(model, "Luckfox Pico Pro") == 0) {
        printf("The device model is Luckfox Pico Pro.\n");
        disp_flag = 1;
    } 
    else if (strcmp(model, "Luckfox Pico Max") == 0) {
        printf("The device model is Luckfox Pico Max.\n");
        disp_flag = 1;
    }
